...
class DE(GeneticAlgorithmBase):
    ...
    def crossover(self):
        ...
        self.U = np.where(mask, self.V, self.X) #self.U=self.V if mask else self.X
        return self.U
    ...
    def run(self, max_iter=None):
        ...
        for i in range(self.max_iter):
            ...
            print('Iter # %d #' % i + ' genreation best X is ' + str(self.X[generation_best_index, :]) +
                  ' generation best Y is ' + str(self.Y[generation_best_index]))
